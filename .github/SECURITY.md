...
package, affected version or commit, reproduction steps, and the expected impact.

## Response Expectations

Maintainers aim to acknowledge reports within 7 days. Confirmed vulnerabilities
will be triaged for severity, fixed on a private branch when appropriate, and
published with release notes once a fix is available.
