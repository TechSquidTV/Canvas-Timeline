...
} from '#full-editor/features/media/library/media-library-manifest';
import type { MediaLibraryManifestSource } from '#full-editor/features/media/library/media-library-types';
