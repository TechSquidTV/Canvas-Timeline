import {
  getSupportedSourceKind,
  probeSourceFile,
} from '#full-editor/features/media/ingest/source-media';
import { errorMessage } from '#full-editor/infrastructure/persistence/opfs/support';
import {
  persistSourceOriginal,
  persistSourcePoster,
  updateMediaLibraryManifest,
} from '#full-editor/features/media/library/media-library-files';
import { createFailedManifestSource } from '#full-editor/features/media/library/media-library-runtime';
import type {
