...
import {
  ...
  timelineMarkers,
  timelineTracks,
} from '#full-editor/features/project/demo-project';
...
import { errorMessage, hasOpfsSupport } from '#full-editor/infrastructure/persistence/opfs/support';
import { loadProjectSnapshot } from '#full-editor/infrastructure/persistence/project/project-store';
import {
